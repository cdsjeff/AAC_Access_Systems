...
- `AAC_Access_Systems_User_Manual_v1.pdf`  
  User manual focused on setup, practice, testing, and classroom use.

- `README.md`  
  This file.

- `CURRENT_UPDATES.md`  
  Revision notes. This file is intended to be appended with each new release.
...
For GitHub Pages:
1. Upload the contents of this ZIP to the repository branch used for GitHub Pages.
2. Make sure `index.html` is at the root of the published folder.
